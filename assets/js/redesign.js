(function () {
  ...
  function buildDrawer() {
    ...
    div.innerHTML =
      ...
      +       '<a href="https://wa.me/5491150196519" target="_blank" rel="noopener">+54 9 11 5019-6519</a>'
      +     '</div>'
      +   '</div>'
      + '</div>';
    return div;
  ...
  function injectPremiumWhatsApp() {
    ...
    var href = wasapAnchor
      ...
      : 'https://api.whatsapp.com/send?l=es&text=Hola%20Raven3!&phone=5491150196519';
